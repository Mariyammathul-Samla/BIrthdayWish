...
def write_happy_inside_circle(text_color, x, y):
 ...
 my_turtle_cursor.begin_fill()
 my_turtle_cursor.pendown()
 my_turtle_cursor.write("HAPPYYY", font=("calibri", 26, "bold"))
 my_turtle_cursor.getscreen().update()
...
def write_birthday_inside_circle(text_color, x, y):
 ...
 my_turtle_cursor.begin_fill()
 my_turtle_cursor.pendown()
 my_turtle_cursor.write("Birthday<3", font=("calibri", 26, "bold"))
 my_turtle_cursor.getscreen().update()
...
parts_of_cake = []
parts_of_cake.append(["indigo", "#000000", 3, 20])
parts_of_cake.append(["purple", "#000000", 3, 20])
parts_of_cake.append(["lightblue", "#000000", 3, 20])
parts_of_cake.append(["green", "#000000", 3, 20])
parts_of_cake.append(["yellow", "#000000", 3, 20])
parts_of_cake.append(["orange", "#000000", 3, 20])
parts_of_cake.append(["red", "#000000", 3, 20])
#parts_of_cake.append(["black", "#000000", 3, 20])
...
draw_toppings_on_cake("violet", "#000000", -120, y_coordinate - 60, 10)
draw_toppings_on_cake("green", "#000000", -80, y_coordinate - 60, 10)
draw_toppings_on_cake("blue", "#000000", 25, y_coordinate - 60, 10)
draw_toppings_on_cake("orange", "#000000", 59, y_coordinate - 60, 10)
# drawing middle topping of our cakes
draw_toppings_on_cake("yellow", "#000000", -135, y_coordinate - 80, 10)
draw_toppings_on_cake("black", "#000000", -135, y_coordinate - 100, 10)
draw_toppings_on_cake("red", "#000000", -135, y_coordinate - 120, 10)
draw_toppings_on_cake("skyblue", "#000000", -80, y_coordinate - 80, 10)
draw_toppings_on_cake("maroon", "#000000", -65, y_coordinate - 110, 10)
...
write_birthday_inside_circle("#000000", -70, y_coordinate + 190)
turtle.done()